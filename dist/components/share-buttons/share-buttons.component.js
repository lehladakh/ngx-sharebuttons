...
var ShareButtonsComponent = (function () {
    ...
    ShareButtonsComponent.prototype.ngOnInit = function () {
        this.buttons = [];
        if (this.facebook) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.FACEBOOK, this.facebook, "facebook " + this.buttonClass));
        }
        if (this.twitter) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.TWITTER, this.twitter, "twitter " + this.buttonClass));
        }
        if (this.google) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.GOOGLEPLUS, this.google, "googleplus " + this.buttonClass));
        }
        if (this.pinterest) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.PINTEREST, this.pinterest, "pinterest " + this.buttonClass));
        }
        if (this.linkedIn) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.LINKEDIN, this.linkedIn, "linkedin " + this.buttonClass));
        }
        if (this.tumblr) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.TUMBLR, this.tumblr, "tumblr " + this.buttonClass));
        }
        if (this.reddit) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.REDDIT, this.reddit, "reddit " + this.buttonClass));
        }
        if (this.stumbleUpOn) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.STUMBLEUPON, this.stumbleUpOn, "stumbleupon " + this.buttonClass));
        }
        if (this.whatsApp) {
            this.buttons.push(new index_1.ShareButton(index_1.ShareProvider.WHATSAPP, this.whatsApp, "whatsapp " + this.buttonClass));
        }
    };
...
ShareButtonsComponent.propDecorators = {
    ...
    'facebook': [{ type: core_1.Input },],
    'twitter': [{ type: core_1.Input },],
    'linkedIn': [{ type: core_1.Input },],
    'tumblr': [{ type: core_1.Input },],
    'google': [{ type: core_1.Input },],
    'pinterest': [{ type: core_1.Input },],
    'stumbleUpOn': [{ type: core_1.Input },],
    'reddit': [{ type: core_1.Input },],
    'whatsApp': [{ type: core_1.Input },],
